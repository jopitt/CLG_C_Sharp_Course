    ...
    class Program
    {
        ...
        static List<Member> ListMembers()
        {
            ...
            var member2 = new Member
            {
                ...
                readingList = new List<Book>{ListBooks().Find(x => x.title == "The Lion, the Witch and the Wardrobe (Chronicles of Narnia, # 1)"), ListBooks().Find(x => x.title == "The Lord of the Rings")}
            };
            ...
            var member3 = new Member
            {
                ...
                readingList = new List<Book>{ListBooks().Find(x => x.title == "1984"), ListBooks().Find(x => x.title == "The Catcher in the Rye")}
